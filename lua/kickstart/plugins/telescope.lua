...
return {
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.treesitter, { desc = 'Search [T]reesitter' })
      vim.keymap.set('n', '<leader>sp', builtin.builtin, { desc = 'Search Telescope [P]ickers' })
      ...
      vim.keymap.set('n', '<leader>svc', builtin.git_commits, { desc = 'Search [V]ersion Control [C]ommits' })
      vim.keymap.set('n', '<leader>svb', builtin.git_bcommits, { desc = 'Search [V]ersion Control [B]uffer Commits' })
      vim.keymap.set('n', '<leader>svs', builtin.git_status, { desc = 'Search [V]ersion Control [S]tatus' })
      vim.keymap.set('n', '<leader>svt', builtin.git_stash, { desc = 'Search [V]ersion Control S[t]ash' })
